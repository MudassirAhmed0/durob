    ...
    >
      ...
      <div className="flex flex-col justify-between grow-[1]">
        <div className="lg:mb-[1.45833333333vw] mb-[20px] flex flex-col lg:gap-y-[0.41666666666vw] gap-y-[4px] lg:mt-[1.82291666667vw] mt-[10px]">
          <h6 className="lg:text28 mtext18 text-[#0F0D0F] lg:min-h-[3.95833333333vw] sm:min-h-[56px] line-clamp-2">
            {news.heading}
          </h6>
          <p className="lg:text22 mtext16 text-[#0F0D0F] text-opacity-[0.9] lg:leading-[1.66666666667vw]">
            {news.desc}
          </p>
        </div>
