    ...
    <section className="lg:mt-[-10.8333333333vw] sm:mt-[-16vw] mt-[-28vw]">
      <div className=" w-full bg-[#002B87] relative flex items-end lg:pt-[27.8125vw] sm:pt-[350px] pt-[250px] lg:pb-[18.8020833333vw] sm:pb-[250px] pb-[150px]">
        ...
        <div className="relative z-[2] container1680">
          <ContentWrapper
            heading={data?.title_heading || "Operations In 8 Regions"}
            desc={data?.description || "We operate in key cities including Riyadh, Dammam, Jeddah, Madinah, Sakaka, and Khamis Mushiat. Our extensive network ensures we can serve clients across the entire kingdom efficiently"}
