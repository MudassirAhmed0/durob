...
const AllServices = () => {
  ...
  const updateCurrentHeader = () => {
    services.map((item) => {
      if (
        document.getElementById(item.id)?.getBoundingClientRect().top <= 200
      ) {
        ...
        >
          {services.map((service) => (
            <button
              ...
              className={clsx(
                "lg:text22 md:mtext18 text-[12px] capitalize text-center border-[#FFFFFF1A] ltr:border-r rtl:border-l lg:px-[2.1875vw] lg:py-[0.88541666666vw] p-[15px] relative before:absolute before:lrf1",
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-[2] flex flex-wrap justify-center items-center lg:gap-[4.42708333333vw] sm:gap-[50px] gap-[40px] container1680">
                ...
                >
                  <ImageComponent alt={"banner-img"} src={service.img} />
                </div>
